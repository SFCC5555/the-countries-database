const Search = ({mode})=> {
    return (
        <div className="relative sm:w-1/3">
            <input className={`w-full h-12 rounded-md ${mode}ModeElement placeholder:pl-16 placeholder:text-sm hover:opacity-80`} type='search' placeholder="Search for a country..." />
